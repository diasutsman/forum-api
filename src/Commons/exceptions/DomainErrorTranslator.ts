...
const DomainErrorTranslator: Props = {
  ...
  _directories: {
    ...
    'REGISTER_USER.USERNAME_LIMIT_CHAR':
      new InvariantError(
          'tidak dapat membuat user baru karena karakter username ' +
        'melebihi batas limit',
      ),
  
    'REGISTER_USER.USERNAME_CONTAIN_RESTRICTED_CHARACTER':
      new InvariantError(
          'tidak dapat membuat user baru karena username' +
        ' mengandung karakter terlarang',
      ),
    ...
    new InvariantError(
        'tidak dapat membuat thread baru karena '+
        'properti yang dibutuhkan tidak ada',
    ),
    ...
    new InvariantError(
        'tidak dapat menambahkan komentar baru karena '+
        'properti yang dibutuhkan tidak ada',
    ),
