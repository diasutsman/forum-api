...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(
        ...
        new InvariantError(
            'tidak dapat membuat user baru karena karakter '+
            'username melebihi batas limit',
        ),
    );
    ...
    expect(
        ...
        new InvariantError(
            'tidak dapat membuat user baru karena username mengandung '+
            'karakter terlarang',
        ),
    );
  });
  ...
  it(
      'should return original error when error message '+
    'is not needed to translate',
      () => {
        // Arrange
